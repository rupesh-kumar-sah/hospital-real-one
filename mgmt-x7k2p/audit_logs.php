...
$breadcrumbs = [['label' => 'Dashboard', 'url' => adminUrl('dashboard.php')], ['label' => 'Audit Logs']];
...
<div class="card mb-24" style="background: linear-gradient(135deg, #0f172a, #1e293b); color: #fff; padding: 24px; border-radius: 12px; border: 1px solid #334155;">
    <div class="d-flex align-center gap-16 mb-16" style="justify-content: space-between; flex-wrap: wrap;">
        <div class="d-flex align-center gap-16">
            ...
            <div>
                <h3 style="margin: 0; color: #fff; font-size: 1.15rem;">Database Storage: <code style="color: #38bdf8; background: rgba(56, 189, 248, 0.1); padding: 3px 8px; border-radius: 6px;">Neon PostgreSQL</code></h3>
                <p style="margin: 4px 0 0 0; color: #94a3b8; font-size: 0.875rem;">
                    Patient records, clinical data, prescriptions, lab reports, billing, and audit logs are stored in the connected Neon database over SSL.
                </p>
            </div>
        </div>
    </div>
    <div style="border-top: 1px solid #334155; pt: 14px; margin-top: 14px; font-size: 0.8125rem; color: #cbd5e1; display: flex; align-items: center; gap: 8px;">
        ...
        <span>All CRUD operations are performed against Neon PostgreSQL. Local HM DATA exports are disabled.</span>
    </div>
</div>
    ...
    <div class="card-body">
        <form method="GET" action="" class="d-flex gap-16" style="flex-wrap: wrap; align-items: flex-end;">
            ...
            <div>
                ...
                <a href="<?= adminUrl('audit_logs.php') ?>" class="btn btn-secondary"><i class="fas fa-undo"></i> Reset</a>
            </div>
        </form>
    </div>
</div>
